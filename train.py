...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # Save checkpoint
        if is_best:
            torch.save(model.state_dict(), 'models/BEST_checkpoint' + '_b_' + str(args.batch_size)
                       + '_n_' + str(args.noise_level) + '_a_' + str(args.alpha) + '.pt')
